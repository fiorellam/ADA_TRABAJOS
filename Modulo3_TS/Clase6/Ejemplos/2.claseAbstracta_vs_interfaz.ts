...
//usaremos una clase abstracta 'vehiculo' para definir el comportamiento general de todos los vehiculos y crearemos una interfa
//'electrico' para los vehiculos que pueden cargarse electronicamente

...
//Este ejemplo muestra como path.join maneja el segmento 
// '..' que indica 'subir de directorio'
// '/user' + 'local' sube un nivel con '..' y llega a 'bin'
//resultado : \user\bin
const ejemplo3 = path.join('/user', 'local', '..', 'bin')
console.log("Ejemplo 3 - Rutas normalizadas con '..'  barras redundantes", ejemplo3);

//Ejemplo 4 Construciion ruta relativa multiplataforma
